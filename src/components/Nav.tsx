...
const Nav = () => {
  ...
  return (
    <aside className={`${nav ? ' left-0 z-20 ': " -left-full"} flex flex-col top-0 fixed md:static md:w-auto  w-full h-full bg-slate-950 p-4 pr-0 transition-all `}>
      <nav onClick={()=>setNav(!nav)} className="flex flex-col h-full w-full gap-6 py-6">
        <Logo/>
