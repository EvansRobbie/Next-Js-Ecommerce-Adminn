  ...
  return (
    <aside className="flex flex-col p-4 pr-0 ">
      <Link href={"/"} className="flex items-center gap-4 mr-4">
        ...
        <span className="text-xl font-bold">StoreAdmin</span>
      </Link>
      <nav className="flex flex-col h-full w-full gap-6 py-6">
        ...
        >
          ...
          <span className="capitalize text-lg">products</span>
        </Link>
        <Link
          href={"/categories"}
        ...
        >
          ...
          <span className="capitalize text-lg">categories</span>
        </Link>
        <Link
          href={"/orders"}
        ...
        >
          ...
          <span className="capitalize text-lg">settings</span>
        </Link>
        <button
        onClick={()=>signOut()}
          className='flex gap-4 px-4 inactive'
        >
